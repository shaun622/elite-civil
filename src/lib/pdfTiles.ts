 ...
 * the model's image cap, blurring small annotations (RL spot levels).
...
// pixel space as the extracted vectors, so RL coordinates the AI returns
// line up with the measured wall geometry.
